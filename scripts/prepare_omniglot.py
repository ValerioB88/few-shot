...
def handle_characters(alphabet_folder, character_folder, rotate=None):
    for root, _, character_images in os.walk(character_folder):
        ...
        for img_path in character_images:
            ...
            if rotate is not None:
                ...
                io.imsave(f'{alphabet_folder}/{character_name}/{img_path}', img)
            # return
    ...
    if do_rotation:
        ...
        for root, character_folders, _ in os.walk(folder):
            for character_folder in character_folders:
                # For each character folder in an alphabet rotate and resize all of the images and save
                # to the new folder
                handle_characters(folder, root + '/' + character_folder, rotate=None)
